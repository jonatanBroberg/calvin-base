...
class Replicator(object):
    ...
    def replicate_lost_actor(self, lost_actor_id, lost_actor_info, replica_id, replica_node, cb):
        cb = CalvinCB(self._replicate, lost_actor_id=lost_actor_id, lost_actor_info=lost_actor_info, 
                        replica_id=replica_id, replica_node=replica_node, cb=cb)
        self._delete_lost_actor(lost_actor_info, lost_actor_id, cb=cb)

    def _replicate(self, status, lost_actor_id, lost_actor_info, replica_id, replica_node, cb):
        available_nodes = []
